...
%%Figure 1
%% Raw data corresponding to Figure 3(a) in the paper. This plot presents the absorption spectra of all optimized structures(a-i) in chemical potentia =0eV and incident Angle of 0 degree. 
figure(1)
set(gcf,'color','w');
...
%% It displays the absorption spectra of all optimized structures (a–i) at a chemical potential of 0 eV and an incident angle of 45 degrees.
figure(2)
set(gcf,'color','w');
...
%% While the figure in the paper is a 3D plot, this graph shows the 2D version. 
%% It displays the absorption spectra of all optimized structures (a–i) at a chemical potential of 1 eV and an incident angle of 0 degrees.
figure(3)
set(gcf,'color','w');
